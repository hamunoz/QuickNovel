...
const val DOWNLOAD_UNREAD_ONLY_FILTER: String = "download_unread_only_filter"
const val DOWNLOAD_COMPLETED_ONLY_FILTER: String = "download_completed_only_filter"
